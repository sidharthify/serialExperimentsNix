#### AUTHORED BY mio-19 on GitHub, this is NOT mine and i have straight up ripped it from there!
#### There *may* be a few changes i do but i did not write any of the original

# https://github.com/mio-19/nurpkgs/blob/main/by-name/darling/package.nix
